...
function klikk() {
    ...
    switch(numberOfClicks) {
        ...
        case 10:
            ...
            break;
        case 11:
            document.getElementById("infoskjerm").innerText("Gratulerer du spiste opp hele kaken!");
            break;
      }
...
function restart() {
    ...
    const response = confirm("Er du sikker på at du vil starte på nytt??");
    ...
    if (response) {
        ...
        document.getElementById("infoskjerm").innerText = ""
